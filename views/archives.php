        <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                <h1 class="text-3xl text-black pb-6">Archives</h1>

                <div class="w-full mt-6">
                    <p class="text-xl pb-3 flex items-center">
                        <i class="fas fa-list mr-3"></i>Anciens clients 
                    </p>
                    <div class="flex justify-end items-center my-10 w-full">
                        <div id="search" class="form-search">
                            <input type="text" class="form-input"><i class="fas fa-search mx-3 text-white"></i>
                        </div>
                    </div>
                        ...
                        <table class="min-w-full bg-white">
                            <thead class="bg-gray-800 text-white">
                                <tr>
                                    ...
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Facture (PDF)</th>
                                </tr>
                            </thead>
                            ...
                            <tr>
                                    ...
                                    <td class="text-left py-3 px-4"><a class="hover:text-blue-500" href="PDF_de_la_facture"></a>Facture n°<?php echo $i ?></td>
