...
class GestionContratcontroller extends Controller{


	public function __construct(){

		$this->contrat = new GestionContratModel();
	}
	...
	public function updateEtatProgress($idContrat){
		$this->contrat->updateEtatProgress($idContrat);

		header("location:gestionContrat");
	}
	...
	public function index(){
        ...
        $this->render('gestionContrat', compact('InfosEvent', 'nbrPart', 'infosClient' ));
